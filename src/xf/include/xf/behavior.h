...
protected:
    ...
    void scheduleTimeout(int timeoutId, int interval);	///< @brief Schedules a timeout for this state machine.
    void unscheduleTimeout(int timeoutId);						///< @brief Unschedules a timeout for this state machine.
